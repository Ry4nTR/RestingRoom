...
/// <summary>
/// Room — responsabilità e flusso eventi:
...
/// - `Room.OnInteractionTriggeredByNPC` -> può essere sottoscritto da sistemi globali (es. logging, analytics, AI manager).
/// </summary>
public class Room : MonoBehaviour
{
    ...
    // Metodo helper per mantenere Reset pulito (non cambia comportamento, solo leggibilità)
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            // Emissione evento globale: chi ascolta (es. RoomManager) saprà che il player è entrato in questa stanza.
    ...
    /// Nota: non si occupa di validare quale NPC o se l'interaction era la destinazione attesa — questo è delegato all'`NPC_Controller`.
    /// </summary>
